...
import { prisma } from "@/database/globalForPrisma";
 ...
 */
export function getPrismaModel(modelName: Prisma.ModelName): DynamicReadDelegate {
...
export async function findModelRows(
  ...
  return getPrismaModel(modelName).findMany(args);
}
